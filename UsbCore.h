...
#define bmREQ_SET                                        \
    USB_SETUP_HOST_TO_DEVICE | USB_SETUP_TYPE_STANDARD | \
        USB_SETUP_RECIPIENT_DEVICE  // set request type for all but 'set feature' and 'set
                                    // interface'
...
#define USB_XFER_TIMEOUT \
    5000  // (5000) USB transfer timeout in milliseconds, per section 9.2.6.1 of USB 2.0 spec
// #define USB_NAK_LIMIT         32000   // NAK limit for a transfer. 0 means NAKs are not counted
#define USB_RETRY_LIMIT 3     // 3 retry limit for a transfer
#define USB_SETTLE_DELAY 200  // settle delay in milliseconds

#define USB_NUMDEVICES 16        // number of USB devices
// #define HUB_MAX_HUBS          7       // maximum number of hubs that can be attached to the host
// controller
...
public:
    virtual uint8_t Init(uint8_t parent __attribute__((unused)),
...
public:
    ...
    uint8_t getStrDescr(uint8_t addr, uint8_t ep, uint16_t nbytes, uint8_t index, uint16_t langid,
                        uint8_t *dataptr);
    ...
    uint8_t ctrlReq(uint8_t addr, uint8_t ep, uint8_t bmReqType, uint8_t bRequest, uint8_t wValLo,
