...
const struct {
    ...
    .Config               = {.Header                 = {.Size = sizeof(ConfigurationDescriptor.Config),
    ...
    .I11ReportOUTEndpoint = {.Header            = {.Size =
                             ...
                             .Attributes        = (EP_TYPE_ISOCHRONOUS | ENDPOINT_ATTR_NO_SYNC |
                                            ENDPOINT_USAGE_DATA),
                             .EndpointSize      = 228,
    ...
    .I11ReportINEndpoint  = {.Header = {.Size = sizeof(ConfigurationDescriptor.I11ReportINEndpoint),
                             ...
                             .Attributes =
                                 (EP_TYPE_ISOCHRONOUS | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
                             .EndpointSize      = 228,
                             .PollingIntervalMS = 0x01},
    ...
    .I21ReportINEndpoint  = {
         .Header            = {.Size = sizeof(ConfigurationDescriptor.I21ReportINEndpoint),
                               .Type = DTYPE_Endpoint},
...
const USB_Descriptor_String_t PROGMEM XboxString = {
    ...
    .UnicodeString =
        L"Xbox Security Method 3, Version 1.00, © 2005 Microsoft Corporation. All rights "
        L"reserved."};

const USB_Descriptor_String_t PROGMEM ModString = {
    .Header = {.Size = USB_STRING_LEN(8), .Type = DTYPE_String}, .UnicodeString = L"MSFT100\x90"};
...
const USB_Descriptor_String_t PROGMEM ManufacturerString = {
    ...
    .UnicodeString = L"Performance Designed Products"};

const USB_Descriptor_String_t PROGMEM ProductString = {
    .Header        = {.Size = USB_STRING_LEN(43), .Type = DTYPE_String},
    .UnicodeString = L"Rock Band Wired Legacy Adapter for Xbox One"};

const USB_Descriptor_String_t PROGMEM SerialString = {
    .Header        = {.Size = USB_STRING_LEN(16), .Type = DTYPE_String},
    .UnicodeString = L"0000079C605C57B6"};
