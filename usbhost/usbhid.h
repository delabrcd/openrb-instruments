...
protected:
    ...
    static const uint8_t totalEndpoints    = (maxHidInterfaces * maxEpPerInterface +
...
public:
    ...
    virtual bool SetReportParser(uint8_t          id __attribute__((unused)),
                                 HIDReportParser *prs __attribute__((unused))) {
        return false;
    };
    ...
    uint8_t GetReport(uint8_t ep, uint8_t iface, uint8_t report_type, uint8_t report_id,
                      uint16_t nbytes, uint8_t *dataptr);
    uint8_t SetReport(uint8_t ep, uint8_t iface, uint8_t report_type, uint8_t report_id,
                      uint16_t nbytes, uint8_t *dataptr);
};
